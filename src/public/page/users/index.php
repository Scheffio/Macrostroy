                    ...
                    <div class="permissions">
                        <div class="permission">
                            <div class="permission__checkbox">
                                <div class="admin">
                                    <input type="checkbox" onclick="rolesControl.saveRolePermissions(this)" class="uncheckable" name="access-radio" id="all">
                        ...
                        <div class="permission">
                            <div class="permission__checkbox">
                                <div class="version-control">
                                    <input type="checkbox" onclick="rolesControl.saveRolePermissions(this)" class="uncheckable" name="version-control-radio" id="version-control">
                        ...
                        <div class="permission">
                            <div class="permission__checkbox">
                                <div class="watch">
                                    <input type="checkbox" onclick="rolesControl.saveRolePermissions(this)" class="uncheckable" name="watch-radio" id="watch">

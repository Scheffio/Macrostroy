...
/**
 * Base class that represents a row from the 'technic_version' table.
 *
 *
 *
 * @package    propel.generator.DB.Base
 */
abstract class TechnicVersion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\TechnicVersionTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\TechnicVersion object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>TechnicVersion</code> instance.  If
     * <code>obj</code> is an instance of <code>TechnicVersion</code>, delegates to
     * <code>equals(TechnicVersion)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TechnicVersionTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[TechnicVersionTableMap::COL_NAME] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[TechnicVersionTableMap::COL_PRICE] = true;
        }
    ...
    public function setIsAvailable($v)
    {
        ...
        if ($this->is_available !== $v) {
            $this->is_available = $v;
            $this->modifiedColumns[TechnicVersionTableMap::COL_IS_AVAILABLE] = true;
        }
    ...
    public function setUnitId($v)
    {
        ...
        if ($this->unit_id !== $v) {
            $this->unit_id = $v;
            $this->modifiedColumns[TechnicVersionTableMap::COL_UNIT_ID] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[TechnicVersionTableMap::COL_VERSION] = true;
        }
    ...
    public function setVersionCreatedAt($v)
    {
        ...
        if ($this->version_created_at !== null || $dt !== null) {
            if ($this->version_created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->version_created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TechnicVersionTableMap::COL_VERSION_CREATED_AT] = true;
            }
    ...
    public function setVersionCreatedBy($v)
    {
        ...
        if ($this->version_created_by !== $v) {
            ...
            $this->modifiedColumns[TechnicVersionTableMap::COL_VERSION_CREATED_BY] = true;
        }
    ...
    public function setVersionComment($v)
    {
        ...
        if ($this->version_comment !== $v) {
            ...
            $this->modifiedColumns[TechnicVersionTableMap::COL_VERSION_COMMENT] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TechnicVersionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TechnicVersionTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TechnicVersionTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TechnicVersionTableMap::translateFieldName('IsAvailable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_available = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TechnicVersionTableMap::translateFieldName('UnitId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->unit_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TechnicVersionTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TechnicVersionTableMap::translateFieldName('VersionCreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->version_created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : TechnicVersionTableMap::translateFieldName('VersionCreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version_created_by = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : TechnicVersionTableMap::translateFieldName('VersionComment', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 13; // 13 = TechnicVersionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DB\\TechnicVersion'), 0, $e);
        }
    }
    ...
    {
        if ($this->aTechnic !== null && $this->id !== $this->aTechnic->getId()) {
            $this->aTechnic = null;
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildTechnicVersionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see TechnicVersion::setDeleted()
     * @see TechnicVersion::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTechnicVersionQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TechnicVersionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(TechnicVersionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_IS_AVAILABLE)) {
            $modifiedColumns[':p' . $index++]  = 'is_available';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_UNIT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'unit_id';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'version';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_VERSION_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_at';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_VERSION_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_by';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_VERSION_COMMENT)) {
            $modifiedColumns[':p' . $index++]  = 'version_comment';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_STAGE_TECHNIC_IDS)) {
            $modifiedColumns[':p' . $index++]  = 'stage_technic_ids';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_STAGE_TECHNIC_VERSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'stage_technic_versions';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_WORK_TECHNIC_IDS)) {
            $modifiedColumns[':p' . $index++]  = 'work_technic_ids';
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_WORK_TECHNIC_VERSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'work_technic_versions';
        }

        $sql = sprintf(
            'INSERT INTO technic_version (%s) VALUES (%s)',
    ...
    {
        $pos = TechnicVersionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TechnicVersion'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['TechnicVersion'][$this->hashCode()] = true;
        $keys = TechnicVersionTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(TechnicVersionTableMap::COL_ID)) {
            $criteria->add(TechnicVersionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_NAME)) {
            $criteria->add(TechnicVersionTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_PRICE)) {
            $criteria->add(TechnicVersionTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_IS_AVAILABLE)) {
            $criteria->add(TechnicVersionTableMap::COL_IS_AVAILABLE, $this->is_available);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_UNIT_ID)) {
            $criteria->add(TechnicVersionTableMap::COL_UNIT_ID, $this->unit_id);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_VERSION)) {
            $criteria->add(TechnicVersionTableMap::COL_VERSION, $this->version);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_VERSION_CREATED_AT)) {
            $criteria->add(TechnicVersionTableMap::COL_VERSION_CREATED_AT, $this->version_created_at);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_VERSION_CREATED_BY)) {
            $criteria->add(TechnicVersionTableMap::COL_VERSION_CREATED_BY, $this->version_created_by);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_VERSION_COMMENT)) {
            $criteria->add(TechnicVersionTableMap::COL_VERSION_COMMENT, $this->version_comment);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_STAGE_TECHNIC_IDS)) {
            $criteria->add(TechnicVersionTableMap::COL_STAGE_TECHNIC_IDS, $this->stage_technic_ids);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_STAGE_TECHNIC_VERSIONS)) {
            $criteria->add(TechnicVersionTableMap::COL_STAGE_TECHNIC_VERSIONS, $this->stage_technic_versions);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_WORK_TECHNIC_IDS)) {
            $criteria->add(TechnicVersionTableMap::COL_WORK_TECHNIC_IDS, $this->work_technic_ids);
        }
        if ($this->isColumnModified(TechnicVersionTableMap::COL_WORK_TECHNIC_VERSIONS)) {
            $criteria->add(TechnicVersionTableMap::COL_WORK_TECHNIC_VERSIONS, $this->work_technic_versions);
        }
    ...
    {
        $criteria = ChildTechnicVersionQuery::create();
        $criteria->add(TechnicVersionTableMap::COL_ID, $this->id);
        $criteria->add(TechnicVersionTableMap::COL_VERSION, $this->version);
    ...
    public function hashCode()
    {
        ...
        //relation technic_version_fk_9f10cd to table technic
        if ($this->aTechnic && $hash = spl_object_hash($this->aTechnic)) {
            $primaryKeyFKs[] = $hash;
        } else {
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\TechnicVersion (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\TechnicVersion Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aTechnic === null && ($this->id != 0)) {
            $this->aTechnic = ChildTechnicQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTechnic->addTechnicVersions($this);
             */
        }
    ...
    {
        if (null !== $this->aTechnic) {
            $this->aTechnic->removeTechnicVersion($this);
        }
        $this->id = null;
        $this->name = null;
        $this->price = null;
    ...
    {
        return (string) $this->exportTo(TechnicVersionTableMap::DEFAULT_STRING_FORMAT);
    }

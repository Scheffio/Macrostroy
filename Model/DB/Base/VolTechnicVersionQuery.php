 ...
 * @method     ChildVolTechnicVersion|null findOneByVersionCreatedBy(string $version_created_by) Return the first ChildVolTechnicVersion filtered by the version_created_by column
 ...
 * @method     ChildVolTechnicVersion requireOneByVersionCreatedBy(string $version_created_by) Return the first ChildVolTechnicVersion filtered by the version_created_by column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildVolTechnicVersion[]|Collection findByVersionCreatedBy(string $version_created_by) Return ChildVolTechnicVersion objects filtered by the version_created_by column
 * @psalm-method Collection&\Traversable<ChildVolTechnicVersion> findByVersionCreatedBy(string $version_created_by) Return ChildVolTechnicVersion objects filtered by the version_created_by column
...
abstract class VolTechnicVersionQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, price, is_available, unit_id, version, version_created_at, version_created_by, version_comment, obj_stage_technic_ids, obj_stage_technic_versions, vol_work_technic_ids, vol_work_technic_versions FROM vol_technic_version WHERE id = :p0 AND version = :p1';
        try {

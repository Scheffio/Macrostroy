...
/**
 * Base class that represents a row from the 'obj_stage_technic_version' table.
 *
 *
 *
 * @package    propel.generator.DB.Base
 */
abstract class ObjStageTechnicVersion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\ObjStageTechnicVersionTableMap';
    ...
    /**
     * @var        ChildObjStageTechnic
     */
    protected $aObjStageTechnic;
    ...
    /**
     * Initializes internal state of DB\Base\ObjStageTechnicVersion object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ObjStageTechnicVersion</code> instance.  If
     * <code>obj</code> is an instance of <code>ObjStageTechnicVersion</code>, delegates to
     * <code>equals(ObjStageTechnicVersion)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ObjStageTechnicVersionTableMap::COL_ID] = true;
        }

        if ($this->aObjStageTechnic !== null && $this->aObjStageTechnic->getId() !== $v) {
            $this->aObjStageTechnic = null;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[ObjStageTechnicVersionTableMap::COL_PRICE] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[ObjStageTechnicVersionTableMap::COL_AMOUNT] = true;
        }
    ...
    public function setIsAvailable($v)
    {
        ...
        if ($this->is_available !== $v) {
            $this->is_available = $v;
            $this->modifiedColumns[ObjStageTechnicVersionTableMap::COL_IS_AVAILABLE] = true;
        }
    ...
    public function setTechnicId($v)
    {
        ...
        if ($this->technic_id !== $v) {
            $this->technic_id = $v;
            $this->modifiedColumns[ObjStageTechnicVersionTableMap::COL_TECHNIC_ID] = true;
        }
    ...
    public function setStageWorkId($v)
    {
        ...
        if ($this->stage_work_id !== $v) {
            ...
            $this->modifiedColumns[ObjStageTechnicVersionTableMap::COL_STAGE_WORK_ID] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[ObjStageTechnicVersionTableMap::COL_VERSION] = true;
        }
    ...
    public function setVersionComment($v)
    {
        ...
        if ($this->version_comment !== $v) {
            ...
            $this->modifiedColumns[ObjStageTechnicVersionTableMap::COL_VERSION_COMMENT] = true;
        }
    ...
    public function setStageWorkIdVersion($v)
    {
        ...
        if ($this->stage_work_id_version !== $v) {
            ...
            $this->modifiedColumns[ObjStageTechnicVersionTableMap::COL_STAGE_WORK_ID_VERSION] = true;
        }
    ...
    public function setTechnicIdVersion($v)
    {
        ...
        if ($this->technic_id_version !== $v) {
            ...
            $this->modifiedColumns[ObjStageTechnicVersionTableMap::COL_TECHNIC_ID_VERSION] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ObjStageTechnicVersionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ObjStageTechnicVersionTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ObjStageTechnicVersionTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ObjStageTechnicVersionTableMap::translateFieldName('IsAvailable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_available = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ObjStageTechnicVersionTableMap::translateFieldName('TechnicId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ObjStageTechnicVersionTableMap::translateFieldName('StageWorkIdVersion', TableMap::TYPE_PHPNAME, $indexType)];
            $this->stage_work_id_version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ObjStageTechnicVersionTableMap::translateFieldName('TechnicIdVersion', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 12; // 12 = ObjStageTechnicVersionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DB\\ObjStageTechnicVersion'), 0, $e);
        }
    }
    ...
    {
        if ($this->aObjStageTechnic !== null && $this->id !== $this->aObjStageTechnic->getId()) {
            $this->aObjStageTechnic = null;
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildObjStageTechnicVersionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see ObjStageTechnicVersion::setDeleted()
     * @see ObjStageTechnicVersion::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildObjStageTechnicVersionQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ObjStageTechnicVersionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con): int
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aObjStageTechnic !== null) {
                if ($this->aObjStageTechnic->isModified() || $this->aObjStageTechnic->isNew()) {
                    $affectedRows += $this->aObjStageTechnic->save($con);
                }
                $this->setObjStageTechnic($this->aObjStageTechnic);
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'amount';
        }
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_IS_AVAILABLE)) {
            $modifiedColumns[':p' . $index++]  = 'is_available';
        }
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_TECHNIC_ID)) {
        ...
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_STAGE_WORK_ID_VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'stage_work_id_version';
        }
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_TECHNIC_ID_VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'technic_id_version';
        }

        $sql = sprintf(
            'INSERT INTO obj_stage_technic_version (%s) VALUES (%s)',
    ...
    {
        $pos = ObjStageTechnicVersionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ObjStageTechnicVersion'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['ObjStageTechnicVersion'][$this->hashCode()] = true;
        $keys = ObjStageTechnicVersionTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            ...
            if (null !== $this->aObjStageTechnic) {
                ...
                switch ($keyType) {
                    ...
                    case TableMap::TYPE_FIELDNAME:
                        $key = 'obj_stage_technic';
                        break;
                    default:
                        $key = 'ObjStageTechnic';
                }

                $result[$key] = $this->aObjStageTechnic->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_ID)) {
            $criteria->add(ObjStageTechnicVersionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_PRICE)) {
            $criteria->add(ObjStageTechnicVersionTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_AMOUNT)) {
            $criteria->add(ObjStageTechnicVersionTableMap::COL_AMOUNT, $this->amount);
        }
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_IS_AVAILABLE)) {
            $criteria->add(ObjStageTechnicVersionTableMap::COL_IS_AVAILABLE, $this->is_available);
        }
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_TECHNIC_ID)) {
            $criteria->add(ObjStageTechnicVersionTableMap::COL_TECHNIC_ID, $this->technic_id);
        }
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_STAGE_WORK_ID)) {
        ...
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_STAGE_WORK_ID_VERSION)) {
            $criteria->add(ObjStageTechnicVersionTableMap::COL_STAGE_WORK_ID_VERSION, $this->stage_work_id_version);
        }
        if ($this->isColumnModified(ObjStageTechnicVersionTableMap::COL_TECHNIC_ID_VERSION)) {
            $criteria->add(ObjStageTechnicVersionTableMap::COL_TECHNIC_ID_VERSION, $this->technic_id_version);
        }
    ...
    {
        $criteria = ChildObjStageTechnicVersionQuery::create();
        $criteria->add(ObjStageTechnicVersionTableMap::COL_ID, $this->id);
        $criteria->add(ObjStageTechnicVersionTableMap::COL_VERSION, $this->version);
    ...
    public function hashCode()
    {
        ...
        //relation obj_stage_technic_version_fk_63bbbc to table obj_stage_technic
        if ($this->aObjStageTechnic && $hash = spl_object_hash($this->aObjStageTechnic)) {
            $primaryKeyFKs[] = $hash;
        } else {
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\ObjStageTechnicVersion (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\ObjStageTechnicVersion Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildObjStageTechnic object.
     *
     * @param ChildObjStageTechnic $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setObjStageTechnic(ChildObjStageTechnic $v = null)
    {
        if ($v === null) {
            $this->setId(NULL);
        } else {
        ...
        $this->aObjStageTechnic = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildObjStageTechnic object, it will not be re-added.
        if ($v !== null) {
            $v->addObjStageTechnicVersion($this);
        }
    ...
    /**
     * Get the associated ChildObjStageTechnic object
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildObjStageTechnic The associated ChildObjStageTechnic object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getObjStageTechnic(?ConnectionInterface $con = null)
    {
        if ($this->aObjStageTechnic === null && ($this->id != 0)) {
            $this->aObjStageTechnic = ChildObjStageTechnicQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aObjStageTechnic->addObjStageTechnicVersions($this);
             */
        }

        return $this->aObjStageTechnic;
    }
    ...
    {
        if (null !== $this->aObjStageTechnic) {
            $this->aObjStageTechnic->removeObjStageTechnicVersion($this);
        }
        $this->id = null;
        $this->price = null;
        $this->amount = null;
    ...
    {
        return (string) $this->exportTo(ObjStageTechnicVersionTableMap::DEFAULT_STRING_FORMAT);
    }

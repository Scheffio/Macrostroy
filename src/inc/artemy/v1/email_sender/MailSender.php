...
class MailSender
{
    public static function sendAccountCreatedByAdmin($mail_receiver, $link): bool
    {
        return self::send(
            ...
            "  <h1>Здравствуйте!</h1>
                    <p>Ваш аккаунт был зарегистрирован администратором. Перейдите по ссылке и придумайте пароль. Ссылка действует только 24 часа.</p>
                    <br>
                    <a href='$link'>Создать аккаунт</a>
                    <br>

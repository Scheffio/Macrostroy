 ...
 *
 * @method     \DB\VolUnitQuery|\DB\ObjStageMaterialQuery|\DB\VolWorkMaterialQuery|\DB\VolMaterialVersionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildVolMaterial|null findOneByVersionCreatedBy(string $version_created_by) Return the first ChildVolMaterial filtered by the version_created_by column
 ...
 * @method     ChildVolMaterial requireOneByVersionCreatedBy(string $version_created_by) Return the first ChildVolMaterial filtered by the version_created_by column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildVolMaterial[]|Collection findByVersionCreatedBy(string $version_created_by) Return ChildVolMaterial objects filtered by the version_created_by column
 * @psalm-method Collection&\Traversable<ChildVolMaterial> findByVersionCreatedBy(string $version_created_by) Return ChildVolMaterial objects filtered by the version_created_by column
...
protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';
    ...
    {
        $sql = 'SELECT id, name, price, is_available, unit_id, version, version_created_at, version_created_by, version_comment FROM vol_material WHERE id = :p0';
        try {

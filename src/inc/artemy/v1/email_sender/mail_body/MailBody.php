...
class MailBody
{
    public static function getAccountCreatedByAdminSubject(): string
    {
        return "Ваш аккаунт был создан администратором";
    }

    public static function getAccountCreatedByAdminBody($mail_receiver, $link): string
    {
        ob_start();
        ?>
        <!DOCTYPE html
                                                            ...
                                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td style="font-style: italic; padding-top: 20px;">
                                                                        <p class="about">Не работает кнопка? Скопируйте
                                                                            ссылку и вставьте в окно браузера:</p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
    ...
    public static function getAccountCreatedByAdminAltBody($mail_receiver, $link): string
    {
        return "Ваш аккаунт был создан администратором. Перейдите по ссылке и придумайте пароль. Ссылка действует только 24 часа. \n$link";
    }


    public static function getPasswordChangeSubject(): string
    {
        return "Вы запросили восстановление пароля";
    }

    public static function getPasswordChangeBody($mail_receiver, $link_to_change_password): string
    {
        ob_start();
        ?>
        <!DOCTYPE html
    ...
    public static function getPasswordChangeAltBody($mail_receiver, $link_to_change_password): string
    {
        return "Забыли пароль? Перейдите по ссылке и придумайте новый пароль. Ссылка действует только 24 часа. Если вы не отправляли запрос на восстановление пароля, то не обращайте внимания на это письмо. \n$link_to_change_password";
    }
}
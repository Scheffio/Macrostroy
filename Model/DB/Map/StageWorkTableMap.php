...
class StageWorkTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Price', 'Amount', 'WorkId', 'StageId', ],
        self::TYPE_CAMELNAME     => ['id', 'price', 'amount', 'workId', 'stageId', ],
        self::TYPE_COLNAME       => [StageWorkTableMap::COL_ID, StageWorkTableMap::COL_PRICE, StageWorkTableMap::COL_AMOUNT, StageWorkTableMap::COL_WORK_ID, StageWorkTableMap::COL_STAGE_ID, ],
        self::TYPE_FIELDNAME     => ['id', 'price', 'amount', 'work_id', 'stage_id', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Price' => 1, 'Amount' => 2, 'WorkId' => 3, 'StageId' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'price' => 1, 'amount' => 2, 'workId' => 3, 'stageId' => 4, ],
        self::TYPE_COLNAME       => [StageWorkTableMap::COL_ID => 0, StageWorkTableMap::COL_PRICE => 1, StageWorkTableMap::COL_AMOUNT => 2, StageWorkTableMap::COL_WORK_ID => 3, StageWorkTableMap::COL_STAGE_ID => 4, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'price' => 1, 'amount' => 2, 'work_id' => 3, 'stage_id' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];

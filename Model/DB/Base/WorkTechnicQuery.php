 ...
 *
 * @method     \DB\TechnicQuery|\DB\WorkQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class WorkTechnicQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, technic_id, work_id, amount FROM work_technic WHERE id = :p0';
        try {

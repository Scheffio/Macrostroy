...
class WorkMaterialTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'MaterialId', 'WorkId', 'Amount', ],
        self::TYPE_CAMELNAME     => ['id', 'materialId', 'workId', 'amount', ],
        self::TYPE_COLNAME       => [WorkMaterialTableMap::COL_ID, WorkMaterialTableMap::COL_MATERIAL_ID, WorkMaterialTableMap::COL_WORK_ID, WorkMaterialTableMap::COL_AMOUNT, ],
        self::TYPE_FIELDNAME     => ['id', 'material_id', 'work_id', 'amount', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'MaterialId' => 1, 'WorkId' => 2, 'Amount' => 3, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'materialId' => 1, 'workId' => 2, 'amount' => 3, ],
        self::TYPE_COLNAME       => [WorkMaterialTableMap::COL_ID => 0, WorkMaterialTableMap::COL_MATERIAL_ID => 1, WorkMaterialTableMap::COL_WORK_ID => 2, WorkMaterialTableMap::COL_AMOUNT => 3, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'material_id' => 1, 'work_id' => 2, 'amount' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];

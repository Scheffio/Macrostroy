...
/**
 * Base class that represents a row from the 'groups_version' table.
 *
 *
 *
 * @package    propel.generator.DB.Base
 */
abstract class GroupsVersion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\GroupsVersionTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\GroupsVersion object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>GroupsVersion</code> instance.  If
     * <code>obj</code> is an instance of <code>GroupsVersion</code>, delegates to
     * <code>equals(GroupsVersion)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[GroupsVersionTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[GroupsVersionTableMap::COL_NAME] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[GroupsVersionTableMap::COL_STATUS] = true;
        }
    ...
    public function setIsAvailable($v)
    {
        ...
        if ($this->is_available !== $v) {
            $this->is_available = $v;
            $this->modifiedColumns[GroupsVersionTableMap::COL_IS_AVAILABLE] = true;
        }
    ...
    public function setSubprojectId($v)
    {
        ...
        if ($this->subproject_id !== $v) {
            ...
            $this->modifiedColumns[GroupsVersionTableMap::COL_SUBPROJECT_ID] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[GroupsVersionTableMap::COL_VERSION] = true;
        }
    ...
    public function setSubprojectIdVersion($v)
    {
        ...
        if ($this->subproject_id_version !== $v) {
            ...
            $this->modifiedColumns[GroupsVersionTableMap::COL_SUBPROJECT_ID_VERSION] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GroupsVersionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GroupsVersionTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GroupsVersionTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : GroupsVersionTableMap::translateFieldName('IsAvailable', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 12; // 12 = GroupsVersionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DB\\GroupsVersion'), 0, $e);
        }
    }
    ...
    {
        if ($this->aGroups !== null && $this->id !== $this->aGroups->getId()) {
            $this->aGroups = null;
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildGroupsVersionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see GroupsVersion::setDeleted()
     * @see GroupsVersion::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGroupsVersionQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GroupsVersionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(GroupsVersionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(GroupsVersionTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(GroupsVersionTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(GroupsVersionTableMap::COL_IS_AVAILABLE)) {
        ...
        if ($this->isColumnModified(GroupsVersionTableMap::COL_HOUSE_IDS)) {
            $modifiedColumns[':p' . $index++]  = 'house_ids';
        }
        if ($this->isColumnModified(GroupsVersionTableMap::COL_HOUSE_VERSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'house_versions';
        }

        $sql = sprintf(
            'INSERT INTO groups_version (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'subproject_id_version':
                        ...
                        break;
                    case 'house_ids':
                        $stmt->bindValue($identifier, $this->house_ids, PDO::PARAM_STR);
                        break;
                    case 'house_versions':
                        $stmt->bindValue($identifier, $this->house_versions, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = GroupsVersionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 10:
                return $this->getHouseIds();

            case 11:
                return $this->getHouseVersions();
    ...
    {
        if (isset($alreadyDumpedObjects['GroupsVersion'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['GroupsVersion'][$this->hashCode()] = true;
        $keys = GroupsVersionTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[10], $arr)) {
            $this->setHouseIds($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setHouseVersions($arr[$keys[11]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(GroupsVersionTableMap::COL_ID)) {
            $criteria->add(GroupsVersionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(GroupsVersionTableMap::COL_NAME)) {
            $criteria->add(GroupsVersionTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(GroupsVersionTableMap::COL_STATUS)) {
            $criteria->add(GroupsVersionTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(GroupsVersionTableMap::COL_IS_AVAILABLE)) {
            $criteria->add(GroupsVersionTableMap::COL_IS_AVAILABLE, $this->is_available);
        }
        if ($this->isColumnModified(GroupsVersionTableMap::COL_SUBPROJECT_ID)) {
        ...
        if ($this->isColumnModified(GroupsVersionTableMap::COL_HOUSE_IDS)) {
            $criteria->add(GroupsVersionTableMap::COL_HOUSE_IDS, $this->house_ids);
        }
        if ($this->isColumnModified(GroupsVersionTableMap::COL_HOUSE_VERSIONS)) {
            $criteria->add(GroupsVersionTableMap::COL_HOUSE_VERSIONS, $this->house_versions);
        }
    ...
    {
        $criteria = ChildGroupsVersionQuery::create();
        $criteria->add(GroupsVersionTableMap::COL_ID, $this->id);
        $criteria->add(GroupsVersionTableMap::COL_VERSION, $this->version);
    ...
    public function hashCode()
    {
        ...
        //relation groups_version_fk_48de95 to table groups
        if ($this->aGroups && $hash = spl_object_hash($this->aGroups)) {
            $primaryKeyFKs[] = $hash;
        } else {
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\GroupsVersion (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\GroupsVersion Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aGroups === null && ($this->id != 0)) {
            $this->aGroups = ChildGroupsQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGroups->addGroupsVersions($this);
             */
        }
    ...
    {
        if (null !== $this->aGroups) {
            $this->aGroups->removeGroupsVersion($this);
        }
        $this->id = null;
        $this->name = null;
        $this->status = null;
    ...
    {
        return (string) $this->exportTo(GroupsVersionTableMap::DEFAULT_STRING_FORMAT);
    }

 ...
 * @method     ChildStageMaterialQuery orderByStageId($order = Criteria::ASC) Order by the stage_id column
 *
 ...
 * @method     ChildStageMaterialQuery groupByStageId() Group by the stage_id column
 *
 ...
 *
 * @method     ChildStageMaterialQuery leftJoinStage($relationAlias = null) Adds a LEFT JOIN clause to the query using the Stage relation
 * @method     ChildStageMaterialQuery rightJoinStage($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Stage relation
 * @method     ChildStageMaterialQuery innerJoinStage($relationAlias = null) Adds a INNER JOIN clause to the query using the Stage relation
 *
 * @method     ChildStageMaterialQuery joinWithStage($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Stage relation
 *
 * @method     ChildStageMaterialQuery leftJoinWithStage() Adds a LEFT JOIN clause and with to the query using the Stage relation
 * @method     ChildStageMaterialQuery rightJoinWithStage() Adds a RIGHT JOIN clause and with to the query using the Stage relation
 * @method     ChildStageMaterialQuery innerJoinWithStage() Adds a INNER JOIN clause and with to the query using the Stage relation
 *
 * @method     \DB\MaterialQuery|\DB\StageQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildStageMaterial|null findOneByStageId(int $stage_id) Return the first ChildStageMaterial filtered by the stage_id column *
 ...
 * @method     ChildStageMaterial requireOneByStageId(int $stage_id) Return the first ChildStageMaterial filtered by the stage_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildStageMaterial[]|Collection findByStageId(int $stage_id) Return ChildStageMaterial objects filtered by the stage_id column
 * @psalm-method Collection&\Traversable<ChildStageMaterial> findByStageId(int $stage_id) Return ChildStageMaterial objects filtered by the stage_id column
...
abstract class StageMaterialQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, price, amount, material_id, stage_id FROM stage_material WHERE id = :p0';
        try {
    ...
    public function filterByStageId($stageId = null, ?string $comparison = null)
    {
        if (is_array($stageId)) {
            ...
            if (isset($stageId['min'])) {
                $this->addUsingAlias(StageMaterialTableMap::COL_STAGE_ID, $stageId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($stageId['max'])) {
                $this->addUsingAlias(StageMaterialTableMap::COL_STAGE_ID, $stageId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $this->addUsingAlias(StageMaterialTableMap::COL_STAGE_ID, $stageId, $comparison);
    ...
    public function filterByStage($stage, ?string $comparison = null)
    {
        if ($stage instanceof \DB\Stage) {
            return $this
                ->addUsingAlias(StageMaterialTableMap::COL_STAGE_ID, $stage->getId(), $comparison);
            ...
            $this
                ->addUsingAlias(StageMaterialTableMap::COL_STAGE_ID, $stage->toKeyValue('PrimaryKey', 'Id'), $comparison);

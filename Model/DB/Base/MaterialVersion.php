...
/**
 * Base class that represents a row from the 'material_version' table.
 *
 *
 *
 * @package    propel.generator.DB.Base
 */
abstract class MaterialVersion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\MaterialVersionTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\MaterialVersion object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>MaterialVersion</code> instance.  If
     * <code>obj</code> is an instance of <code>MaterialVersion</code>, delegates to
     * <code>equals(MaterialVersion)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MaterialVersionTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[MaterialVersionTableMap::COL_NAME] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[MaterialVersionTableMap::COL_PRICE] = true;
        }
    ...
    public function setIsAvailable($v)
    {
        ...
        if ($this->is_available !== $v) {
            $this->is_available = $v;
            $this->modifiedColumns[MaterialVersionTableMap::COL_IS_AVAILABLE] = true;
        }
    ...
    public function setUnitId($v)
    {
        ...
        if ($this->unit_id !== $v) {
            $this->unit_id = $v;
            $this->modifiedColumns[MaterialVersionTableMap::COL_UNIT_ID] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[MaterialVersionTableMap::COL_VERSION] = true;
        }
    ...
    public function setVersionCreatedAt($v)
    {
        ...
        if ($this->version_created_at !== null || $dt !== null) {
            if ($this->version_created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->version_created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MaterialVersionTableMap::COL_VERSION_CREATED_AT] = true;
            }
    ...
    public function setVersionCreatedBy($v)
    {
        ...
        if ($this->version_created_by !== $v) {
            ...
            $this->modifiedColumns[MaterialVersionTableMap::COL_VERSION_CREATED_BY] = true;
        }
    ...
    public function setVersionComment($v)
    {
        ...
        if ($this->version_comment !== $v) {
            ...
            $this->modifiedColumns[MaterialVersionTableMap::COL_VERSION_COMMENT] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MaterialVersionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MaterialVersionTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MaterialVersionTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MaterialVersionTableMap::translateFieldName('IsAvailable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_available = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MaterialVersionTableMap::translateFieldName('UnitId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->unit_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MaterialVersionTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : MaterialVersionTableMap::translateFieldName('VersionCreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->version_created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : MaterialVersionTableMap::translateFieldName('VersionCreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version_created_by = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : MaterialVersionTableMap::translateFieldName('VersionComment', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 13; // 13 = MaterialVersionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DB\\MaterialVersion'), 0, $e);
        }
    }
    ...
    {
        if ($this->aMaterial !== null && $this->id !== $this->aMaterial->getId()) {
            $this->aMaterial = null;
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildMaterialVersionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see MaterialVersion::setDeleted()
     * @see MaterialVersion::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMaterialVersionQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MaterialVersionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(MaterialVersionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_IS_AVAILABLE)) {
            $modifiedColumns[':p' . $index++]  = 'is_available';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_UNIT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'unit_id';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'version';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_VERSION_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_at';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_VERSION_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_by';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_VERSION_COMMENT)) {
            $modifiedColumns[':p' . $index++]  = 'version_comment';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_STAGE_MATERIAL_IDS)) {
            $modifiedColumns[':p' . $index++]  = 'stage_material_ids';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_STAGE_MATERIAL_VERSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'stage_material_versions';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_WORK_MATERIAL_IDS)) {
            $modifiedColumns[':p' . $index++]  = 'work_material_ids';
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_WORK_MATERIAL_VERSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'work_material_versions';
        }

        $sql = sprintf(
            'INSERT INTO material_version (%s) VALUES (%s)',
    ...
    {
        $pos = MaterialVersionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['MaterialVersion'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['MaterialVersion'][$this->hashCode()] = true;
        $keys = MaterialVersionTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            ...
            $keys[11] => $this->getWorkMaterialIds(),
            $keys[12] => $this->getWorkMaterialVersions(),
        ];
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[11], $arr)) {
            $this->setWorkMaterialIds($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setWorkMaterialVersions($arr[$keys[12]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(MaterialVersionTableMap::COL_ID)) {
            $criteria->add(MaterialVersionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_NAME)) {
            $criteria->add(MaterialVersionTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_PRICE)) {
            $criteria->add(MaterialVersionTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_IS_AVAILABLE)) {
            $criteria->add(MaterialVersionTableMap::COL_IS_AVAILABLE, $this->is_available);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_UNIT_ID)) {
            $criteria->add(MaterialVersionTableMap::COL_UNIT_ID, $this->unit_id);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_VERSION)) {
            $criteria->add(MaterialVersionTableMap::COL_VERSION, $this->version);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_VERSION_CREATED_AT)) {
            $criteria->add(MaterialVersionTableMap::COL_VERSION_CREATED_AT, $this->version_created_at);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_VERSION_CREATED_BY)) {
            $criteria->add(MaterialVersionTableMap::COL_VERSION_CREATED_BY, $this->version_created_by);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_VERSION_COMMENT)) {
            $criteria->add(MaterialVersionTableMap::COL_VERSION_COMMENT, $this->version_comment);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_STAGE_MATERIAL_IDS)) {
            $criteria->add(MaterialVersionTableMap::COL_STAGE_MATERIAL_IDS, $this->stage_material_ids);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_STAGE_MATERIAL_VERSIONS)) {
            $criteria->add(MaterialVersionTableMap::COL_STAGE_MATERIAL_VERSIONS, $this->stage_material_versions);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_WORK_MATERIAL_IDS)) {
            $criteria->add(MaterialVersionTableMap::COL_WORK_MATERIAL_IDS, $this->work_material_ids);
        }
        if ($this->isColumnModified(MaterialVersionTableMap::COL_WORK_MATERIAL_VERSIONS)) {
            $criteria->add(MaterialVersionTableMap::COL_WORK_MATERIAL_VERSIONS, $this->work_material_versions);
        }
    ...
    {
        $criteria = ChildMaterialVersionQuery::create();
        $criteria->add(MaterialVersionTableMap::COL_ID, $this->id);
        $criteria->add(MaterialVersionTableMap::COL_VERSION, $this->version);
    ...
    public function hashCode()
    {
        ...
        //relation material_version_fk_8d347e to table material
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\MaterialVersion (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\MaterialVersion Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aMaterial === null && ($this->id != 0)) {
            $this->aMaterial = ChildMaterialQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMaterial->addMaterialVersions($this);
             */
        }
    ...
    {
        if (null !== $this->aMaterial) {
            $this->aMaterial->removeMaterialVersion($this);
        }
        $this->id = null;
        $this->name = null;
        $this->price = null;
    ...
    {
        return (string) $this->exportTo(MaterialVersionTableMap::DEFAULT_STRING_FORMAT);
    }

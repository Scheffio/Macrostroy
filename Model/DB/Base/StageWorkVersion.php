 ...
 */
abstract class StageWorkVersion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\StageWorkVersionTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\StageWorkVersion object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>StageWorkVersion</code> instance.  If
     * <code>obj</code> is an instance of <code>StageWorkVersion</code>, delegates to
     * <code>equals(StageWorkVersion)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[StageWorkVersionTableMap::COL_ID] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[StageWorkVersionTableMap::COL_PRICE] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[StageWorkVersionTableMap::COL_AMOUNT] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[StageWorkVersionTableMap::COL_VERSION] = true;
        }
    ...
    {
        if ($this->aStageWork !== null && $this->id !== $this->aStageWork->getId()) {
            $this->aStageWork = null;
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildStageWorkVersionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see StageWorkVersion::setDeleted()
     * @see StageWorkVersion::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildStageWorkVersionQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StageWorkVersionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO stage_work_version (%s) VALUES (%s)',
    ...
    {
        $pos = StageWorkVersionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StageWorkVersion'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['StageWorkVersion'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildStageWorkVersionQuery::create();
        $criteria->add(StageWorkVersionTableMap::COL_ID, $this->id);
        $criteria->add(StageWorkVersionTableMap::COL_VERSION, $this->version);
    ...
    public function hashCode()
    {
        ...
        //relation stage_work_version_fk_7e51cc to table stage_work
        if ($this->aStageWork && $hash = spl_object_hash($this->aStageWork)) {
            $primaryKeyFKs[] = $hash;
        } else {
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\StageWorkVersion (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\StageWorkVersion Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aStageWork === null && ($this->id != 0)) {
            $this->aStageWork = ChildStageWorkQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aStageWork->addStageWorkVersions($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(StageWorkVersionTableMap::DEFAULT_STRING_FORMAT);
    }

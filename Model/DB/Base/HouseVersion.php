 ...
 */
abstract class HouseVersion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\HouseVersionTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\HouseVersion object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>HouseVersion</code> instance.  If
     * <code>obj</code> is an instance of <code>HouseVersion</code>, delegates to
     * <code>equals(HouseVersion)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[HouseVersionTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[HouseVersionTableMap::COL_NAME] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[HouseVersionTableMap::COL_STATUS] = true;
        }
    ...
    public function setIsAvailable($v)
    {
        ...
        if ($this->is_available !== $v) {
            $this->is_available = $v;
            $this->modifiedColumns[HouseVersionTableMap::COL_IS_AVAILABLE] = true;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[HouseVersionTableMap::COL_GROUP_ID] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[HouseVersionTableMap::COL_VERSION] = true;
        }
    ...
    public function setGroupIdVersion($v)
    {
        ...
        if ($this->group_id_version !== $v) {
            ...
            $this->modifiedColumns[HouseVersionTableMap::COL_GROUP_ID_VERSION] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : HouseVersionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : HouseVersionTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : HouseVersionTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : HouseVersionTableMap::translateFieldName('IsAvailable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_available = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : HouseVersionTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    {
        if ($this->aHouse !== null && $this->id !== $this->aHouse->getId()) {
            $this->aHouse = null;
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildHouseVersionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see HouseVersion::setDeleted()
     * @see HouseVersion::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildHouseVersionQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HouseVersionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(HouseVersionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(HouseVersionTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(HouseVersionTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(HouseVersionTableMap::COL_IS_AVAILABLE)) {
            $modifiedColumns[':p' . $index++]  = 'is_available';
        }
        if ($this->isColumnModified(HouseVersionTableMap::COL_GROUP_ID)) {
        ...
        if ($this->isColumnModified(HouseVersionTableMap::COL_STAGE_IDS)) {
            $modifiedColumns[':p' . $index++]  = 'stage_ids';
        }
        if ($this->isColumnModified(HouseVersionTableMap::COL_STAGE_VERSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'stage_versions';
        }

        $sql = sprintf(
            'INSERT INTO house_version (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'group_id_version':
                        ...
                        break;
                    case 'stage_ids':
                        $stmt->bindValue($identifier, $this->stage_ids, PDO::PARAM_STR);
                        break;
                    case 'stage_versions':
                        $stmt->bindValue($identifier, $this->stage_versions, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = HouseVersionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['HouseVersion'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['HouseVersion'][$this->hashCode()] = true;
        $keys = HouseVersionTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(HouseVersionTableMap::COL_ID)) {
            $criteria->add(HouseVersionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(HouseVersionTableMap::COL_NAME)) {
            $criteria->add(HouseVersionTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(HouseVersionTableMap::COL_STATUS)) {
            $criteria->add(HouseVersionTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(HouseVersionTableMap::COL_IS_AVAILABLE)) {
            $criteria->add(HouseVersionTableMap::COL_IS_AVAILABLE, $this->is_available);
        }
        if ($this->isColumnModified(HouseVersionTableMap::COL_GROUP_ID)) {
            $criteria->add(HouseVersionTableMap::COL_GROUP_ID, $this->group_id);
        }
        if ($this->isColumnModified(HouseVersionTableMap::COL_VERSION)) {
        ...
        if ($this->isColumnModified(HouseVersionTableMap::COL_STAGE_IDS)) {
            $criteria->add(HouseVersionTableMap::COL_STAGE_IDS, $this->stage_ids);
        }
        if ($this->isColumnModified(HouseVersionTableMap::COL_STAGE_VERSIONS)) {
            $criteria->add(HouseVersionTableMap::COL_STAGE_VERSIONS, $this->stage_versions);
        }
    ...
    {
        $criteria = ChildHouseVersionQuery::create();
        $criteria->add(HouseVersionTableMap::COL_ID, $this->id);
        $criteria->add(HouseVersionTableMap::COL_VERSION, $this->version);
    ...
    public function hashCode()
    {
        ...
        //relation house_version_fk_fa1e78 to table house
        if ($this->aHouse && $hash = spl_object_hash($this->aHouse)) {
            $primaryKeyFKs[] = $hash;
        } else {
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\HouseVersion (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\HouseVersion Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aHouse === null && ($this->id != 0)) {
            $this->aHouse = ChildHouseQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aHouse->addHouseVersions($this);
             */
        }
    ...
    {
        if (null !== $this->aHouse) {
            $this->aHouse->removeHouseVersion($this);
        }
        $this->id = null;
        $this->name = null;
        $this->status = null;
    ...
    {
        return (string) $this->exportTo(HouseVersionTableMap::DEFAULT_STRING_FORMAT);
    }

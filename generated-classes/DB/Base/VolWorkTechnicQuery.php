 ...
 * @method     ChildVolWorkTechnicQuery orderByIsAvailable($order = Criteria::ASC) Order by the is_available column
 ...
 * @method     ChildVolWorkTechnicQuery groupByIsAvailable() Group by the is_available column
 ...
 *
 * @method     ChildVolWorkTechnicQuery leftJoinUsers($relationAlias = null) Adds a LEFT JOIN clause to the query using the Users relation
 * @method     ChildVolWorkTechnicQuery rightJoinUsers($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Users relation
 * @method     ChildVolWorkTechnicQuery innerJoinUsers($relationAlias = null) Adds a INNER JOIN clause to the query using the Users relation
 *
 * @method     ChildVolWorkTechnicQuery joinWithUsers($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Users relation
 *
 * @method     ChildVolWorkTechnicQuery leftJoinWithUsers() Adds a LEFT JOIN clause and with to the query using the Users relation
 * @method     ChildVolWorkTechnicQuery rightJoinWithUsers() Adds a RIGHT JOIN clause and with to the query using the Users relation
 * @method     ChildVolWorkTechnicQuery innerJoinWithUsers() Adds a INNER JOIN clause and with to the query using the Users relation
 *
 ...
 *
 * @method     \DB\UsersQuery|\DB\VolWorkQuery|\DB\VolTechnicQuery|\DB\VolWorkTechnicVersionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildVolWorkTechnic|null findOneByIsAvailable(boolean $is_available) Return the first ChildVolWorkTechnic filtered by the is_available column
 ...
 * @method     ChildVolWorkTechnic|null findOneByVersionCreatedBy(int $version_created_by) Return the first ChildVolWorkTechnic filtered by the version_created_by column
 ...
 * @method     ChildVolWorkTechnic requireOneByIsAvailable(boolean $is_available) Return the first ChildVolWorkTechnic filtered by the is_available column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildVolWorkTechnic requireOneByVersionCreatedBy(int $version_created_by) Return the first ChildVolWorkTechnic filtered by the version_created_by column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildVolWorkTechnic[]|Collection findByIsAvailable(boolean $is_available) Return ChildVolWorkTechnic objects filtered by the is_available column
 * @psalm-method Collection&\Traversable<ChildVolWorkTechnic> findByIsAvailable(boolean $is_available) Return ChildVolWorkTechnic objects filtered by the is_available column
 ...
 * @method     ChildVolWorkTechnic[]|Collection findByVersionCreatedBy(int $version_created_by) Return ChildVolWorkTechnic objects filtered by the version_created_by column
 * @psalm-method Collection&\Traversable<ChildVolWorkTechnic> findByVersionCreatedBy(int $version_created_by) Return ChildVolWorkTechnic objects filtered by the version_created_by column
...
protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';
    ...
    {
        $sql = 'SELECT id, amount, is_available, work_id, technic_id, version_created_by, version, version_created_at, version_comment FROM vol_work_technic WHERE id = :p0';
        try {
    ...
    public function filterByIsAvailable($isAvailable = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(VolWorkTechnicTableMap::COL_IS_AVAILABLE, $isAvailable, $comparison);
    ...
    public function filterByVersionCreatedBy($versionCreatedBy = null, ?string $comparison = null)
    {
        if (is_array($versionCreatedBy)) {
            ...
            if (isset($versionCreatedBy['min'])) {
                $this->addUsingAlias(VolWorkTechnicTableMap::COL_VERSION_CREATED_BY, $versionCreatedBy['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($versionCreatedBy['max'])) {
                $this->addUsingAlias(VolWorkTechnicTableMap::COL_VERSION_CREATED_BY, $versionCreatedBy['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByUsers($users, ?string $comparison = null)
    {
        if ($users instanceof \DB\Users) {
            return $this
                ->addUsingAlias(VolWorkTechnicTableMap::COL_VERSION_CREATED_BY, $users->getId(), $comparison);
            ...
            $this
                ->addUsingAlias(VolWorkTechnicTableMap::COL_VERSION_CREATED_BY, $users->toKeyValue('PrimaryKey', 'Id'), $comparison);

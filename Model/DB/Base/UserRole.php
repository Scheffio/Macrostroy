...
abstract class UserRole implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\UserRoleTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\UserRole object.
     * @see applyDefaults()
     */
    ...
    public function setObjectViewer($v)
    {
        ...
        if ($this->object_viewer !== $v) {
            ...
            $this->modifiedColumns[UserRoleTableMap::COL_OBJECT_VIEWER] = true;
        }
    ...
    public function setManageObjects($v)
    {
        ...
        if ($this->manage_objects !== $v) {
            ...
            $this->modifiedColumns[UserRoleTableMap::COL_MANAGE_OBJECTS] = true;
        }
    ...
    public function setManageVolumes($v)
    {
        ...
        if ($this->manage_volumes !== $v) {
            ...
            $this->modifiedColumns[UserRoleTableMap::COL_MANAGE_VOLUMES] = true;
        }
    ...
    public function setManageHistory($v)
    {
        ...
        if ($this->manage_history !== $v) {
            ...
            $this->modifiedColumns[UserRoleTableMap::COL_MANAGE_HISTORY] = true;
        }
    ...
    public function setManageUsers($v)
    {
        ...
        if ($this->manage_users !== $v) {
            $this->manage_users = $v;
            $this->modifiedColumns[UserRoleTableMap::COL_MANAGE_USERS] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserRoleTableMap::translateFieldName('ObjectViewer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->object_viewer = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserRoleTableMap::translateFieldName('ManageObjects', TableMap::TYPE_PHPNAME, $indexType)];
            $this->manage_objects = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserRoleTableMap::translateFieldName('ManageVolumes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->manage_volumes = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UserRoleTableMap::translateFieldName('ManageHistory', TableMap::TYPE_PHPNAME, $indexType)];
            $this->manage_history = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UserRoleTableMap::translateFieldName('ManageUsers', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = UserRoleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DB\\UserRole'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(UserRoleTableMap::COL_OBJECT_VIEWER)) {
            $modifiedColumns[':p' . $index++]  = 'object_viewer';
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_MANAGE_OBJECTS)) {
            $modifiedColumns[':p' . $index++]  = 'manage_objects';
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_MANAGE_VOLUMES)) {
            $modifiedColumns[':p' . $index++]  = 'manage_volumes';
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_MANAGE_HISTORY)) {
            $modifiedColumns[':p' . $index++]  = 'manage_history';
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_MANAGE_USERS)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(UserRoleTableMap::COL_OBJECT_VIEWER)) {
            $criteria->add(UserRoleTableMap::COL_OBJECT_VIEWER, $this->object_viewer);
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_MANAGE_OBJECTS)) {
            $criteria->add(UserRoleTableMap::COL_MANAGE_OBJECTS, $this->manage_objects);
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_MANAGE_VOLUMES)) {
            $criteria->add(UserRoleTableMap::COL_MANAGE_VOLUMES, $this->manage_volumes);
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_MANAGE_HISTORY)) {
            $criteria->add(UserRoleTableMap::COL_MANAGE_HISTORY, $this->manage_history);
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_MANAGE_USERS)) {
            $criteria->add(UserRoleTableMap::COL_MANAGE_USERS, $this->manage_users);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\UserRole (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\UserRole Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function initUserss(bool $overrideExisting = true): void
    {
        ...
        $this->collUserss->setModel('\DB\Users');
    }

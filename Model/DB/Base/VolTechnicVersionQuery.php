...
abstract class VolTechnicVersionQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, price, is_available, unit_id, version, version_created_at, version_created_by, version_comment, obj_stage_technic_ids, obj_stage_technic_versions FROM vol_technic_version WHERE id = :p0 AND version = :p1';
        try {

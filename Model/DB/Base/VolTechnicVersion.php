...
/**
 * Base class that represents a row from the 'vol_technic_version' table.
 *
 *
 *
 * @package    propel.generator.DB.Base
 */
abstract class VolTechnicVersion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\VolTechnicVersionTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\VolTechnicVersion object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>VolTechnicVersion</code> instance.  If
     * <code>obj</code> is an instance of <code>VolTechnicVersion</code>, delegates to
     * <code>equals(VolTechnicVersion)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[VolTechnicVersionTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[VolTechnicVersionTableMap::COL_NAME] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[VolTechnicVersionTableMap::COL_PRICE] = true;
        }
    ...
    public function setIsAvailable($v)
    {
        ...
        if ($this->is_available !== $v) {
            $this->is_available = $v;
            $this->modifiedColumns[VolTechnicVersionTableMap::COL_IS_AVAILABLE] = true;
        }
    ...
    public function setUnitId($v)
    {
        ...
        if ($this->unit_id !== $v) {
            $this->unit_id = $v;
            $this->modifiedColumns[VolTechnicVersionTableMap::COL_UNIT_ID] = true;
        }
    ...
    public function setVersionCreatedBy($v)
    {
        ...
        if ($this->version_created_by !== $v) {
            ...
            $this->modifiedColumns[VolTechnicVersionTableMap::COL_VERSION_CREATED_BY] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[VolTechnicVersionTableMap::COL_VERSION] = true;
        }
    ...
    public function setVersionCreatedAt($v)
    {
        ...
        if ($this->version_created_at !== null || $dt !== null) {
            if ($this->version_created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->version_created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[VolTechnicVersionTableMap::COL_VERSION_CREATED_AT] = true;
            }
    ...
    public function setVersionComment($v)
    {
        ...
        if ($this->version_comment !== $v) {
            ...
            $this->modifiedColumns[VolTechnicVersionTableMap::COL_VERSION_COMMENT] = true;
        }
    ...
    public function setObjStageTechnicIds($v)
    {
        if ($this->obj_stage_technic_ids_unserialized !== $v) {
            ...
            $this->modifiedColumns[VolTechnicVersionTableMap::COL_OBJ_STAGE_TECHNIC_IDS] = true;
        }
    ...
    public function setObjStageTechnicVersions($v)
    {
        if ($this->obj_stage_technic_versions_unserialized !== $v) {
            ...
            $this->modifiedColumns[VolTechnicVersionTableMap::COL_OBJ_STAGE_TECHNIC_VERSIONS] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : VolTechnicVersionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : VolTechnicVersionTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VolTechnicVersionTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : VolTechnicVersionTableMap::translateFieldName('IsAvailable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_available = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : VolTechnicVersionTableMap::translateFieldName('UnitId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->unit_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : VolTechnicVersionTableMap::translateFieldName('VersionCreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version_created_by = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : VolTechnicVersionTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : VolTechnicVersionTableMap::translateFieldName('VersionCreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->version_created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : VolTechnicVersionTableMap::translateFieldName('VersionComment', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version_comment = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : VolTechnicVersionTableMap::translateFieldName('ObjStageTechnicIds', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    {
        if ($this->aVolTechnic !== null && $this->id !== $this->aVolTechnic->getId()) {
            $this->aVolTechnic = null;
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildVolTechnicVersionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see VolTechnicVersion::setDeleted()
     * @see VolTechnicVersion::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildVolTechnicVersionQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VolTechnicVersionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_IS_AVAILABLE)) {
            $modifiedColumns[':p' . $index++]  = 'is_available';
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_UNIT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'unit_id';
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_VERSION_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_by';
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'version';
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_VERSION_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_at';
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_VERSION_COMMENT)) {
            $modifiedColumns[':p' . $index++]  = 'version_comment';
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_OBJ_STAGE_TECHNIC_IDS)) {
    ...
    {
        $pos = VolTechnicVersionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VolTechnicVersion'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['VolTechnicVersion'][$this->hashCode()] = true;
        $keys = VolTechnicVersionTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[9], $arr)) {
            $this->setObjStageTechnicIds($arr[$keys[9]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_ID)) {
            $criteria->add(VolTechnicVersionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_NAME)) {
            $criteria->add(VolTechnicVersionTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_PRICE)) {
            $criteria->add(VolTechnicVersionTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_IS_AVAILABLE)) {
            $criteria->add(VolTechnicVersionTableMap::COL_IS_AVAILABLE, $this->is_available);
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_UNIT_ID)) {
            $criteria->add(VolTechnicVersionTableMap::COL_UNIT_ID, $this->unit_id);
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_VERSION_CREATED_BY)) {
            $criteria->add(VolTechnicVersionTableMap::COL_VERSION_CREATED_BY, $this->version_created_by);
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_VERSION)) {
            $criteria->add(VolTechnicVersionTableMap::COL_VERSION, $this->version);
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_VERSION_CREATED_AT)) {
            $criteria->add(VolTechnicVersionTableMap::COL_VERSION_CREATED_AT, $this->version_created_at);
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_VERSION_COMMENT)) {
            $criteria->add(VolTechnicVersionTableMap::COL_VERSION_COMMENT, $this->version_comment);
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_OBJ_STAGE_TECHNIC_IDS)) {
            $criteria->add(VolTechnicVersionTableMap::COL_OBJ_STAGE_TECHNIC_IDS, $this->obj_stage_technic_ids);
        }
        if ($this->isColumnModified(VolTechnicVersionTableMap::COL_OBJ_STAGE_TECHNIC_VERSIONS)) {
    ...
    {
        $criteria = ChildVolTechnicVersionQuery::create();
        $criteria->add(VolTechnicVersionTableMap::COL_ID, $this->id);
        $criteria->add(VolTechnicVersionTableMap::COL_VERSION, $this->version);
    ...
    public function hashCode()
    {
        ...
        //relation vol_technic_version_fk_e379d9 to table vol_technic
        if ($this->aVolTechnic && $hash = spl_object_hash($this->aVolTechnic)) {
            $primaryKeyFKs[] = $hash;
        } else {
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\VolTechnicVersion (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\VolTechnicVersion Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aVolTechnic === null && ($this->id != 0)) {
            $this->aVolTechnic = ChildVolTechnicQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVolTechnic->addVolTechnicVersions($this);
             */
        }
    ...
    {
        if (null !== $this->aVolTechnic) {
            $this->aVolTechnic->removeVolTechnicVersion($this);
        }
        $this->id = null;
        $this->name = null;
        $this->price = null;
    ...
    {
        return (string) $this->exportTo(VolTechnicVersionTableMap::DEFAULT_STRING_FORMAT);
    }

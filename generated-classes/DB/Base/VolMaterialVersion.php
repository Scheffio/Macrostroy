...
/**
 * Base class that represents a row from the 'vol_material_version' table.
 *
 *
 *
 * @package    propel.generator.DB.Base
 */
abstract class VolMaterialVersion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\VolMaterialVersionTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\VolMaterialVersion object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>VolMaterialVersion</code> instance.  If
     * <code>obj</code> is an instance of <code>VolMaterialVersion</code>, delegates to
     * <code>equals(VolMaterialVersion)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_NAME] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_PRICE] = true;
        }
    ...
    public function setIsAvailable($v)
    {
        ...
        if ($this->is_available !== $v) {
            $this->is_available = $v;
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_IS_AVAILABLE] = true;
        }
    ...
    public function setUnitId($v)
    {
        ...
        if ($this->unit_id !== $v) {
            $this->unit_id = $v;
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_UNIT_ID] = true;
        }
    ...
    public function setVersionCreatedBy($v)
    {
        ...
        if ($this->version_created_by !== $v) {
            ...
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_VERSION_CREATED_BY] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_VERSION] = true;
        }
    ...
    public function setVersionCreatedAt($v)
    {
        ...
        if ($this->version_created_at !== null || $dt !== null) {
            if ($this->version_created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->version_created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[VolMaterialVersionTableMap::COL_VERSION_CREATED_AT] = true;
            }
    ...
    public function setVersionComment($v)
    {
        ...
        if ($this->version_comment !== $v) {
            ...
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_VERSION_COMMENT] = true;
        }
    ...
    public function setObjStageMaterialIds($v)
    {
        if ($this->obj_stage_material_ids_unserialized !== $v) {
            ...
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_OBJ_STAGE_MATERIAL_IDS] = true;
        }
    ...
    public function setObjStageMaterialVersions($v)
    {
        if ($this->obj_stage_material_versions_unserialized !== $v) {
            ...
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_OBJ_STAGE_MATERIAL_VERSIONS] = true;
        }
    ...
    public function setVolWorkMaterialIds($v)
    {
        if ($this->vol_work_material_ids_unserialized !== $v) {
            ...
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_VOL_WORK_MATERIAL_IDS] = true;
        }
    ...
    public function setVolWorkMaterialVersions($v)
    {
        if ($this->vol_work_material_versions_unserialized !== $v) {
            ...
            $this->modifiedColumns[VolMaterialVersionTableMap::COL_VOL_WORK_MATERIAL_VERSIONS] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : VolMaterialVersionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : VolMaterialVersionTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VolMaterialVersionTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : VolMaterialVersionTableMap::translateFieldName('IsAvailable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_available = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : VolMaterialVersionTableMap::translateFieldName('UnitId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->unit_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : VolMaterialVersionTableMap::translateFieldName('VersionCreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version_created_by = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : VolMaterialVersionTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : VolMaterialVersionTableMap::translateFieldName('VersionCreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->version_created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : VolMaterialVersionTableMap::translateFieldName('VersionComment', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version_comment = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : VolMaterialVersionTableMap::translateFieldName('ObjStageMaterialIds', TableMap::TYPE_PHPNAME, $indexType)];
            $this->obj_stage_material_ids = $col;
            $this->obj_stage_material_ids_unserialized = null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : VolMaterialVersionTableMap::translateFieldName('ObjStageMaterialVersions', TableMap::TYPE_PHPNAME, $indexType)];
            $this->obj_stage_material_versions = $col;
            $this->obj_stage_material_versions_unserialized = null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : VolMaterialVersionTableMap::translateFieldName('VolWorkMaterialIds', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vol_work_material_ids = $col;
            $this->vol_work_material_ids_unserialized = null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : VolMaterialVersionTableMap::translateFieldName('VolWorkMaterialVersions', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 13; // 13 = VolMaterialVersionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DB\\VolMaterialVersion'), 0, $e);
        }
    }
    ...
    {
        if ($this->aVolMaterial !== null && $this->id !== $this->aVolMaterial->getId()) {
            $this->aVolMaterial = null;
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildVolMaterialVersionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see VolMaterialVersion::setDeleted()
     * @see VolMaterialVersion::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildVolMaterialVersionQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VolMaterialVersionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_IS_AVAILABLE)) {
            $modifiedColumns[':p' . $index++]  = 'is_available';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_UNIT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'unit_id';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VERSION_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_by';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'version';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VERSION_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_at';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VERSION_COMMENT)) {
            $modifiedColumns[':p' . $index++]  = 'version_comment';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_OBJ_STAGE_MATERIAL_IDS)) {
            $modifiedColumns[':p' . $index++]  = 'obj_stage_material_ids';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_OBJ_STAGE_MATERIAL_VERSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'obj_stage_material_versions';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VOL_WORK_MATERIAL_IDS)) {
            $modifiedColumns[':p' . $index++]  = 'vol_work_material_ids';
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VOL_WORK_MATERIAL_VERSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'vol_work_material_versions';
        }

        $sql = sprintf(
            'INSERT INTO vol_material_version (%s) VALUES (%s)',
    ...
    {
        $pos = VolMaterialVersionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VolMaterialVersion'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['VolMaterialVersion'][$this->hashCode()] = true;
        $keys = VolMaterialVersionTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            ...
            $keys[9] => $this->getObjStageMaterialIds(),
            $keys[10] => $this->getObjStageMaterialVersions(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[9], $arr)) {
            $this->setObjStageMaterialIds($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setObjStageMaterialVersions($arr[$keys[10]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_ID)) {
            $criteria->add(VolMaterialVersionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_NAME)) {
            $criteria->add(VolMaterialVersionTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_PRICE)) {
            $criteria->add(VolMaterialVersionTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_IS_AVAILABLE)) {
            $criteria->add(VolMaterialVersionTableMap::COL_IS_AVAILABLE, $this->is_available);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_UNIT_ID)) {
            $criteria->add(VolMaterialVersionTableMap::COL_UNIT_ID, $this->unit_id);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VERSION_CREATED_BY)) {
            $criteria->add(VolMaterialVersionTableMap::COL_VERSION_CREATED_BY, $this->version_created_by);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VERSION)) {
            $criteria->add(VolMaterialVersionTableMap::COL_VERSION, $this->version);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VERSION_CREATED_AT)) {
            $criteria->add(VolMaterialVersionTableMap::COL_VERSION_CREATED_AT, $this->version_created_at);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VERSION_COMMENT)) {
            $criteria->add(VolMaterialVersionTableMap::COL_VERSION_COMMENT, $this->version_comment);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_OBJ_STAGE_MATERIAL_IDS)) {
            $criteria->add(VolMaterialVersionTableMap::COL_OBJ_STAGE_MATERIAL_IDS, $this->obj_stage_material_ids);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_OBJ_STAGE_MATERIAL_VERSIONS)) {
            $criteria->add(VolMaterialVersionTableMap::COL_OBJ_STAGE_MATERIAL_VERSIONS, $this->obj_stage_material_versions);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VOL_WORK_MATERIAL_IDS)) {
            $criteria->add(VolMaterialVersionTableMap::COL_VOL_WORK_MATERIAL_IDS, $this->vol_work_material_ids);
        }
        if ($this->isColumnModified(VolMaterialVersionTableMap::COL_VOL_WORK_MATERIAL_VERSIONS)) {
            $criteria->add(VolMaterialVersionTableMap::COL_VOL_WORK_MATERIAL_VERSIONS, $this->vol_work_material_versions);
        }
    ...
    {
        $criteria = ChildVolMaterialVersionQuery::create();
        $criteria->add(VolMaterialVersionTableMap::COL_ID, $this->id);
        $criteria->add(VolMaterialVersionTableMap::COL_VERSION, $this->version);
    ...
    public function hashCode()
    {
        ...
        //relation vol_material_version_fk_d64a59 to table vol_material
        if ($this->aVolMaterial && $hash = spl_object_hash($this->aVolMaterial)) {
            $primaryKeyFKs[] = $hash;
        } else {
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\VolMaterialVersion (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\VolMaterialVersion Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aVolMaterial === null && ($this->id != 0)) {
            $this->aVolMaterial = ChildVolMaterialQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVolMaterial->addVolMaterialVersions($this);
             */
        }
    ...
    {
        if (null !== $this->aVolMaterial) {
            $this->aVolMaterial->removeVolMaterialVersion($this);
        }
        $this->id = null;
        $this->name = null;
        $this->price = null;
    ...
    {
        return (string) $this->exportTo(VolMaterialVersionTableMap::DEFAULT_STRING_FORMAT);
    }

 ...
 *
 * @method     \DB\VolWorkQuery|\DB\VolMaterialQuery|\DB\VolWorkMaterialVersionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildVolWorkMaterial|null findOneByVersionCreatedBy(string $version_created_by) Return the first ChildVolWorkMaterial filtered by the version_created_by column
 ...
 * @method     ChildVolWorkMaterial requireOneByVersionCreatedBy(string $version_created_by) Return the first ChildVolWorkMaterial filtered by the version_created_by column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildVolWorkMaterial[]|Collection findByVersionCreatedBy(string $version_created_by) Return ChildVolWorkMaterial objects filtered by the version_created_by column
 * @psalm-method Collection&\Traversable<ChildVolWorkMaterial> findByVersionCreatedBy(string $version_created_by) Return ChildVolWorkMaterial objects filtered by the version_created_by column

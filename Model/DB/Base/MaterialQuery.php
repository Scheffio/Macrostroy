 ...
 *
 * @method     \DB\UnitQuery|\DB\StageMaterialQuery|\DB\WorkMaterialQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class MaterialQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, price, is_available, unit_id FROM material WHERE id = :p0';
        try {

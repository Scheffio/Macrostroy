                    ...
                    <div class="permissions">
                        <div class="permission">
                            <div class="permission__checkbox">
                                <div class="admin">
                                    <input type="checkbox" onclick="rolesControl.saveRolePermissions('all', this)" class="uncheckable" name="access-radio" id="all">
                        ...
                        <div class="permission">
                            <div class="permission__checkbox">
                                <div class="version-control">
                                    <input type="checkbox" onclick="rolesControl.saveRolePermissions('version-control', this)" class="uncheckable" name="version-control-radio" id="version-control">

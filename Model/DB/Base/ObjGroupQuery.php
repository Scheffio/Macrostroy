 ...
 *
 * @method     \DB\ObjSubprojectQuery|\DB\ObjHouseQuery|\DB\ObjGroupVersionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildObjGroup|null findOneByVersionCreatedBy(string $version_created_by) Return the first ChildObjGroup filtered by the version_created_by column
 ...
 * @method     ChildObjGroup requireOneByVersionCreatedBy(string $version_created_by) Return the first ChildObjGroup filtered by the version_created_by column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildObjGroup[]|Collection findByVersionCreatedBy(string $version_created_by) Return ChildObjGroup objects filtered by the version_created_by column
 * @psalm-method Collection&\Traversable<ChildObjGroup> findByVersionCreatedBy(string $version_created_by) Return ChildObjGroup objects filtered by the version_created_by column
...
protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';
    ...
    {
        $sql = 'SELECT id, name, status, is_public, is_available, subproject_id, version, version_created_at, version_created_by, version_comment FROM obj_group WHERE id = :p0';
        try {

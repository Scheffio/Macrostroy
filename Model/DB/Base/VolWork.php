...
/**
 * Base class that represents a row from the 'vol_work' table.
 *
 *
 *
 * @package    propel.generator.DB.Base
 */
abstract class VolWork implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\VolWorkTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildVolWorkVersion[] Collection to store aggregation of ChildVolWorkVersion objects.
     * @phpstan-var ObjectCollection&\Traversable<ChildVolWorkVersion> Collection to store aggregation of ChildVolWorkVersion objects.
     */
    protected $collVolWorkVersions;
    protected $collVolWorkVersionsPartial;
    ...
    /**
     * An array of objects scheduled for deletion.
     * @var ObjectCollection|ChildVolWorkVersion[]
     * @phpstan-var ObjectCollection&\Traversable<ChildVolWorkVersion>
     */
    protected $volWorkVersionsScheduledForDeletion = null;
    ...
    /**
     * Initializes internal state of DB\Base\VolWork object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>VolWork</code> instance.  If
     * <code>obj</code> is an instance of <code>VolWork</code>, delegates to
     * <code>equals(VolWork)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[VolWorkTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[VolWorkTableMap::COL_NAME] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[VolWorkTableMap::COL_PRICE] = true;
        }
    ...
    public function setIsAvailable($v)
    {
        ...
        if ($this->is_available !== $v) {
            $this->is_available = $v;
            $this->modifiedColumns[VolWorkTableMap::COL_IS_AVAILABLE] = true;
        }
    ...
    public function setUnitId($v)
    {
        ...
        if ($this->unit_id !== $v) {
            $this->unit_id = $v;
            $this->modifiedColumns[VolWorkTableMap::COL_UNIT_ID] = true;
        }
    ...
    public function setVersionCreatedBy($v)
    {
        ...
        if ($this->version_created_by !== $v) {
            ...
            $this->modifiedColumns[VolWorkTableMap::COL_VERSION_CREATED_BY] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[VolWorkTableMap::COL_VERSION] = true;
        }
    ...
    public function setVersionCreatedAt($v)
    {
        ...
        if ($this->version_created_at !== null || $dt !== null) {
            if ($this->version_created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->version_created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[VolWorkTableMap::COL_VERSION_CREATED_AT] = true;
            }
    ...
    public function setVersionComment($v)
    {
        ...
        if ($this->version_comment !== $v) {
            ...
            $this->modifiedColumns[VolWorkTableMap::COL_VERSION_COMMENT] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : VolWorkTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : VolWorkTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VolWorkTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : VolWorkTableMap::translateFieldName('IsAvailable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_available = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : VolWorkTableMap::translateFieldName('UnitId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->unit_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : VolWorkTableMap::translateFieldName('VersionCreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version_created_by = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : VolWorkTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : VolWorkTableMap::translateFieldName('VersionCreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->version_created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : VolWorkTableMap::translateFieldName('VersionComment', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = VolWorkTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DB\\VolWork'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildVolWorkQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see VolWork::setDeleted()
     * @see VolWork::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildVolWorkQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($this->isVersioningNecessary()) {
                ...
                if (!$this->isColumnModified(VolWorkTableMap::COL_VERSION_CREATED_AT)) {
            ...
            if ($ret) {
                ...
                VolWorkTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con): int
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->volWorkVersionsScheduledForDeletion !== null) {
                if (!$this->volWorkVersionsScheduledForDeletion->isEmpty()) {
                    \DB\VolWorkVersionQuery::create()
                        ->filterByPrimaryKeys($this->volWorkVersionsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->volWorkVersionsScheduledForDeletion = null;
                }
            }

            if ($this->collVolWorkVersions !== null) {
                foreach ($this->collVolWorkVersions as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(VolWorkTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_IS_AVAILABLE)) {
            $modifiedColumns[':p' . $index++]  = 'is_available';
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_UNIT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'unit_id';
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_VERSION_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_by';
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'version';
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_VERSION_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_at';
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_VERSION_COMMENT)) {
            $modifiedColumns[':p' . $index++]  = 'version_comment';
        }

        $sql = sprintf(
            'INSERT INTO vol_work (%s) VALUES (%s)',
    ...
    {
        $pos = VolWorkTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VolWork'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['VolWork'][$this->hashCode()] = true;
        $keys = VolWorkTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collVolWorkVersions) {
                ...
                switch ($keyType) {
                    case TableMap::TYPE_CAMELNAME:
                        ...
                        break;
                    case TableMap::TYPE_FIELDNAME:
                        $key = 'vol_work_versions';
                        break;
                    default:
                        $key = 'VolWorkVersions';
                }

                $result[$key] = $this->collVolWorkVersions->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(VolWorkTableMap::COL_ID)) {
            $criteria->add(VolWorkTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_NAME)) {
            $criteria->add(VolWorkTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_PRICE)) {
            $criteria->add(VolWorkTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_IS_AVAILABLE)) {
            $criteria->add(VolWorkTableMap::COL_IS_AVAILABLE, $this->is_available);
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_UNIT_ID)) {
            $criteria->add(VolWorkTableMap::COL_UNIT_ID, $this->unit_id);
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_VERSION_CREATED_BY)) {
            $criteria->add(VolWorkTableMap::COL_VERSION_CREATED_BY, $this->version_created_by);
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_VERSION)) {
            $criteria->add(VolWorkTableMap::COL_VERSION, $this->version);
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_VERSION_CREATED_AT)) {
            $criteria->add(VolWorkTableMap::COL_VERSION_CREATED_AT, $this->version_created_at);
        }
        if ($this->isColumnModified(VolWorkTableMap::COL_VERSION_COMMENT)) {
            $criteria->add(VolWorkTableMap::COL_VERSION_COMMENT, $this->version_comment);
        }
    ...
    {
        $criteria = ChildVolWorkQuery::create();
        $criteria->add(VolWorkTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\VolWork (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($deepCopy) {
            ...
            foreach ($this->getVolWorkVersions() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addVolWorkVersion($relObj->copy($deepCopy));
                }
            }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\VolWork Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getVolUnit(?ConnectionInterface $con = null)
    {
        if ($this->aVolUnit === null && ($this->unit_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVolUnit->addVolWorks($this);
             */
        }
    ...
    public function initRelation($relationName): void
    {
        ...
        if ('VolWorkVersion' === $relationName) {
            $this->initVolWorkVersions();
            return;
        }
    }
     ...
     * If this ChildVolWork is new, it will return
    ...
    public function setObjStageWorks(Collection $objStageWorks, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($objStageWorksToDelete as $objStageWorkRemoved) {
            $objStageWorkRemoved->setVolWork(null);
        }
     ...
     * Otherwise if this VolWork is new, it will return
     * an empty collection; or if this VolWork has previously
     * been saved, it will retrieve related ObjStageWorks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in VolWork.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
    ...
    public function setVolWorkMaterials(Collection $volWorkMaterials, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($volWorkMaterialsToDelete as $volWorkMaterialRemoved) {
            $volWorkMaterialRemoved->setVolWork(null);
        }
    ...
    protected function doAddVolWorkMaterial(ChildVolWorkMaterial $volWorkMaterial): void
    {
        ...
        $volWorkMaterial->setVolWork($this);
    }
    ...
    public function removeVolWorkMaterial(ChildVolWorkMaterial $volWorkMaterial)
    {
        if ($this->getVolWorkMaterials()->contains($volWorkMaterial)) {
            ...
            $volWorkMaterial->setVolWork(null);
        }
    ...
    public function setVolWorkTechnics(Collection $volWorkTechnics, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($volWorkTechnicsToDelete as $volWorkTechnicRemoved) {
            $volWorkTechnicRemoved->setVolWork(null);
        }
    ...
    protected function doAddVolWorkTechnic(ChildVolWorkTechnic $volWorkTechnic): void
    {
        ...
        $volWorkTechnic->setVolWork($this);
    }
    ...
    public function removeVolWorkTechnic(ChildVolWorkTechnic $volWorkTechnic)
    {
        if ($this->getVolWorkTechnics()->contains($volWorkTechnic)) {
            ...
            $volWorkTechnic->setVolWork(null);
        }
    ...
    /**
     * Clears out the collVolWorkVersions collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return $this
     * @see addVolWorkVersions()
     */
    public function clearVolWorkVersions()
    {
        $this->collVolWorkVersions = null; // important to set this to NULL since that means it is uninitialized

        return $this;
    }

    /**
     * Reset is the collVolWorkVersions collection loaded partially.
     *
     * @return void
     */
    public function resetPartialVolWorkVersions($v = true): void
    {
        $this->collVolWorkVersionsPartial = $v;
    }

    /**
     * Initializes the collVolWorkVersions collection.
     *
     * By default this just sets the collVolWorkVersions collection to an empty array (like clearcollVolWorkVersions());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param bool $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initVolWorkVersions(bool $overrideExisting = true): void
    {
        if (null !== $this->collVolWorkVersions && !$overrideExisting) {
            return;
        }

        $collectionClassName = VolWorkVersionTableMap::getTableMap()->getCollectionClassName();

        $this->collVolWorkVersions = new $collectionClassName;
        $this->collVolWorkVersions->setModel('\DB\VolWorkVersion');
    }

    /**
     * Gets an array of ChildVolWorkVersion objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildVolWorkVersion[] List of ChildVolWorkVersion objects
     * @phpstan-return ObjectCollection&\Traversable<ChildVolWorkVersion> List of ChildVolWorkVersion objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getVolWorkVersions(?Criteria $criteria = null, ?ConnectionInterface $con = null)
    {
        $partial = $this->collVolWorkVersionsPartial && !$this->isNew();
        if (null === $this->collVolWorkVersions || null !== $criteria || $partial) {
            if ($this->isNew()) {
                // return empty collection
                if (null === $this->collVolWorkVersions) {
                    $this->initVolWorkVersions();
                    ...
                    $collVolWorkVersions = new $collectionClassName;
                    $collVolWorkVersions->setModel('\DB\VolWorkVersion');

                    return $collVolWorkVersions;
                }
            } else {
                $collVolWorkVersions = ChildVolWorkVersionQuery::create(null, $criteria)
                    ->filterByVolWork($this)
                    ->find($con);

                if (null !== $criteria) {
                    if (false !== $this->collVolWorkVersionsPartial && count($collVolWorkVersions)) {
                        $this->initVolWorkVersions(false);

                        foreach ($collVolWorkVersions as $obj) {
                            if (false == $this->collVolWorkVersions->contains($obj)) {
                                $this->collVolWorkVersions->append($obj);
                            }
                        }

                        $this->collVolWorkVersionsPartial = true;
                    }

                    return $collVolWorkVersions;
                }

                if ($partial && $this->collVolWorkVersions) {
                    foreach ($this->collVolWorkVersions as $obj) {
                        if ($obj->isNew()) {
                            $collVolWorkVersions[] = $obj;
                        }
                    }
                }

                $this->collVolWorkVersions = $collVolWorkVersions;
                $this->collVolWorkVersionsPartial = false;
            }
        }

        return $this->collVolWorkVersions;
    }

    /**
     * Sets a collection of ChildVolWorkVersion objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param Collection $volWorkVersions A Propel collection.
     * @param ConnectionInterface $con Optional connection object
     * @return $this The current object (for fluent API support)
     */
    public function setVolWorkVersions(Collection $volWorkVersions, ?ConnectionInterface $con = null)
    {
        /** @var ChildVolWorkVersion[] $volWorkVersionsToDelete */
        $volWorkVersionsToDelete = $this->getVolWorkVersions(new Criteria(), $con)->diff($volWorkVersions);


        //since at least one column in the foreign key is at the same time a PK
        //we can not just set a PK to NULL in the lines below. We have to store
        //a backup of all values, so we are able to manipulate these items based on the onDelete value later.
        $this->volWorkVersionsScheduledForDeletion = clone $volWorkVersionsToDelete;

        foreach ($volWorkVersionsToDelete as $volWorkVersionRemoved) {
            $volWorkVersionRemoved->setVolWork(null);
        }

        $this->collVolWorkVersions = null;
        foreach ($volWorkVersions as $volWorkVersion) {
            $this->addVolWorkVersion($volWorkVersion);
        }

        $this->collVolWorkVersions = $volWorkVersions;
        $this->collVolWorkVersionsPartial = false;
    ...
    /**
     * Returns the number of related VolWorkVersion objects.
     *
     * @param Criteria $criteria
     * @param bool $distinct
     * @param ConnectionInterface $con
     * @return int Count of related VolWorkVersion objects.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countVolWorkVersions(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collVolWorkVersionsPartial && !$this->isNew();
        if (null === $this->collVolWorkVersions || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collVolWorkVersions) {
                return 0;
            }

            if ($partial && !$criteria) {
                return count($this->getVolWorkVersions());
            }

            $query = ChildVolWorkVersionQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collVolWorkVersions);
    }

    /**
     * Method called to associate a ChildVolWorkVersion object to this object
     * through the ChildVolWorkVersion foreign key attribute.
     *
     * @param ChildVolWorkVersion $l ChildVolWorkVersion
     * @return $this The current object (for fluent API support)
     */
    public function addVolWorkVersion(ChildVolWorkVersion $l)
    {
        if ($this->collVolWorkVersions === null) {
            $this->initVolWorkVersions();
            $this->collVolWorkVersionsPartial = true;
        ...
        if (!$this->collVolWorkVersions->contains($l)) {
            $this->doAddVolWorkVersion($l);

            if ($this->volWorkVersionsScheduledForDeletion and $this->volWorkVersionsScheduledForDeletion->contains($l)) {
                $this->volWorkVersionsScheduledForDeletion->remove($this->volWorkVersionsScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param ChildVolWorkVersion $volWorkVersion The ChildVolWorkVersion object to add.
     */
    protected function doAddVolWorkVersion(ChildVolWorkVersion $volWorkVersion): void
    {
        $this->collVolWorkVersions[]= $volWorkVersion;
        $volWorkVersion->setVolWork($this);
    }

    /**
     * @param ChildVolWorkVersion $volWorkVersion The ChildVolWorkVersion object to remove.
     * @return $this The current object (for fluent API support)
     */
    public function removeVolWorkVersion(ChildVolWorkVersion $volWorkVersion)
    {
        if ($this->getVolWorkVersions()->contains($volWorkVersion)) {
            $pos = $this->collVolWorkVersions->search($volWorkVersion);
            $this->collVolWorkVersions->remove($pos);
            if (null === $this->volWorkVersionsScheduledForDeletion) {
                $this->volWorkVersionsScheduledForDeletion = clone $this->collVolWorkVersions;
                $this->volWorkVersionsScheduledForDeletion->clear();
            }
            $this->volWorkVersionsScheduledForDeletion[]= clone $volWorkVersion;
            $volWorkVersion->setVolWork(null);
        }
    ...
    {
        if (null !== $this->aUsers) {
            $this->aUsers->removeVolWork($this);
        }
        if (null !== $this->aVolUnit) {
            $this->aVolUnit->removeVolWork($this);
        }
        $this->id = null;
        $this->name = null;
        $this->price = null;
    ...
    public function clearAllReferences(bool $deep = false)
    {
        if ($deep) {
            ...
            if ($this->collVolWorkVersions) {
                foreach ($this->collVolWorkVersions as $o) {
                    $o->clearAllReferences($deep);
                }
            }
        } // if ($deep)
    ...
    {
        return (string) $this->exportTo(VolWorkTableMap::DEFAULT_STRING_FORMAT);
    }
    ...
    public function isVersioningNecessary(?ConnectionInterface $con = null): bool
    {
        ...
        if (ChildVolWorkQuery::isVersioningEnabled() && ($this->isNew() || $this->isModified()) || $this->isDeleted()) {
            return true;
        }
        if ($this->collObjStageWorks) {
     ...
     * @param ConnectionInterface $con The ConnectionInterface connection to use.
     *
     * @return ChildVolWorkVersion A version object
     */
    public function addVersion(?ConnectionInterface $con = null)
    {
        $this->enforceVersion = false;

        $version = new ChildVolWorkVersion();
    ...
    public function toVersion($versionNumber, ?ConnectionInterface $con = null)
    {
        ...
        if (!$version) {
            throw new PropelException(sprintf('No ChildVolWork object found with version %d', $version));
        }
     ...
     * Sets the properties of the current object to the value they had at a specific version
     *
     * @param ChildVolWorkVersion $version The version object to use
    ...
    {
        $loadedObjects['ChildVolWork'][$version->getId()][$version->getVersion()] = $this;
    ...
    {
        $v = ChildVolWorkVersionQuery::create()
            ->filterByVolWork($this)
            ->orderByVersion('desc')
            ->findOne($con);
        if (!$v) {
    ...
    {
        return ChildVolWorkVersionQuery::create()
            ->filterByVolWork($this)
     ...
     * @param ConnectionInterface $con The ConnectionInterface connection to use.
     *
     * @return ObjectCollection|ChildVolWorkVersion[] A list of ChildVolWorkVersion objects
     */
    public function getAllVersions(?ConnectionInterface $con = null)
    {
        $criteria = new Criteria();
        $criteria->addAscendingOrderByColumn(VolWorkVersionTableMap::COL_VERSION);

        return $this->getVolWorkVersions($criteria, $con);
    }
     ...
     * @param ConnectionInterface $con The ConnectionInterface connection to use.
     *
     * @return PropelCollection|\DB\VolWorkVersion[] List of \DB\VolWorkVersion objects
     */
    public function getLastVersions($number = 10, $criteria = null, ?ConnectionInterface $con = null)
    {
        $criteria = ChildVolWorkVersionQuery::create(null, $criteria);
        $criteria->addDescendingOrderByColumn(VolWorkVersionTableMap::COL_VERSION);

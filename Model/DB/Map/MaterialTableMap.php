...
class MaterialTableMap extends TableMap
{
     ...
     */
    public const COL_VERSION = 'material.version';

    /**
     * the column name for the version_created_at field
     */
    public const COL_VERSION_CREATED_AT = 'material.version_created_at';

    /**
     * the column name for the version_created_by field
     */
    public const COL_VERSION_CREATED_BY = 'material.version_created_by';

    /**
     * the column name for the version_comment field
     */
    public const COL_VERSION_COMMENT = 'material.version_comment';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [MaterialTableMap::COL_ID, MaterialTableMap::COL_NAME, MaterialTableMap::COL_PRICE, MaterialTableMap::COL_IS_AVAILABLE, MaterialTableMap::COL_UNIT_ID, MaterialTableMap::COL_VERSION, MaterialTableMap::COL_VERSION_CREATED_AT, MaterialTableMap::COL_VERSION_CREATED_BY, MaterialTableMap::COL_VERSION_COMMENT, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [MaterialTableMap::COL_ID => 0, MaterialTableMap::COL_NAME => 1, MaterialTableMap::COL_PRICE => 2, MaterialTableMap::COL_IS_AVAILABLE => 3, MaterialTableMap::COL_UNIT_ID => 4, MaterialTableMap::COL_VERSION => 5, MaterialTableMap::COL_VERSION_CREATED_AT => 6, MaterialTableMap::COL_VERSION_CREATED_BY => 7, MaterialTableMap::COL_VERSION_COMMENT => 8, ],
    ...
    protected $normalizedColumnNameMap = [
        ...
        'version' => 'VERSION',
        'material.version' => 'VERSION',
        'MaterialTableMap::COL_VERSION' => 'VERSION',
        'COL_VERSION' => 'VERSION',
        'VersionCreatedAt' => 'VERSION_CREATED_AT',
        'Material.VersionCreatedAt' => 'VERSION_CREATED_AT',
        'versionCreatedAt' => 'VERSION_CREATED_AT',
        'material.versionCreatedAt' => 'VERSION_CREATED_AT',
        'MaterialTableMap::COL_VERSION_CREATED_AT' => 'VERSION_CREATED_AT',
        'COL_VERSION_CREATED_AT' => 'VERSION_CREATED_AT',
        'version_created_at' => 'VERSION_CREATED_AT',
        'material.version_created_at' => 'VERSION_CREATED_AT',
        'VersionCreatedBy' => 'VERSION_CREATED_BY',
        'Material.VersionCreatedBy' => 'VERSION_CREATED_BY',
        'versionCreatedBy' => 'VERSION_CREATED_BY',
        'material.versionCreatedBy' => 'VERSION_CREATED_BY',
        'MaterialTableMap::COL_VERSION_CREATED_BY' => 'VERSION_CREATED_BY',
        'COL_VERSION_CREATED_BY' => 'VERSION_CREATED_BY',
        'version_created_by' => 'VERSION_CREATED_BY',
        'material.version_created_by' => 'VERSION_CREATED_BY',
        'VersionComment' => 'VERSION_COMMENT',
        'Material.VersionComment' => 'VERSION_COMMENT',
        'versionComment' => 'VERSION_COMMENT',
        'material.versionComment' => 'VERSION_COMMENT',
        'MaterialTableMap::COL_VERSION_COMMENT' => 'VERSION_COMMENT',
        'COL_VERSION_COMMENT' => 'VERSION_COMMENT',
        'version_comment' => 'VERSION_COMMENT',
        'material.version_comment' => 'VERSION_COMMENT',
    ];
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('MaterialVersion', '\\DB\\MaterialVersion', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
  ),
), 'CASCADE', null, 'MaterialVersions', false);
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to material     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MaterialTableMap::COL_VERSION);
            $criteria->addSelectColumn(MaterialTableMap::COL_VERSION_CREATED_AT);
            $criteria->addSelectColumn(MaterialTableMap::COL_VERSION_CREATED_BY);
            $criteria->addSelectColumn(MaterialTableMap::COL_VERSION_COMMENT);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(MaterialTableMap::COL_VERSION);
            $criteria->removeSelectColumn(MaterialTableMap::COL_VERSION_CREATED_AT);
            $criteria->removeSelectColumn(MaterialTableMap::COL_VERSION_CREATED_BY);
            $criteria->removeSelectColumn(MaterialTableMap::COL_VERSION_COMMENT);
        } else {

 ...
 */
abstract class WorkMaterial implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\WorkMaterialTableMap';
    ...
    /**
     * Compares this with another <code>WorkMaterial</code> instance.  If
     * <code>obj</code> is an instance of <code>WorkMaterial</code>, delegates to
     * <code>equals(WorkMaterial)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setMaterialId($v)
    {
        ...
        if ($this->material_id !== $v) {
            $this->material_id = $v;
            $this->modifiedColumns[WorkMaterialTableMap::COL_MATERIAL_ID] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[WorkMaterialTableMap::COL_AMOUNT] = true;
        }
    ...
    public function setIsAvailable($v)
    {
        ...
        if ($this->is_available !== $v) {
            $this->is_available = $v;
            $this->modifiedColumns[WorkMaterialTableMap::COL_IS_AVAILABLE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : WorkMaterialTableMap::translateFieldName('IsAvailable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_available = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : WorkMaterialTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : WorkMaterialTableMap::translateFieldName('VersionCreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->version_created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : WorkMaterialTableMap::translateFieldName('VersionCreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version_created_by = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : WorkMaterialTableMap::translateFieldName('VersionComment', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = WorkMaterialTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildWorkMaterialQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see WorkMaterial::setDeleted()
     * @see WorkMaterial::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWorkMaterialQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(WorkMaterialTableMap::COL_IS_AVAILABLE)) {
        ...
        $sql = sprintf(
            'INSERT INTO work_material (%s) VALUES (%s)',
    ...
    {
        $pos = WorkMaterialTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['WorkMaterial'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['WorkMaterial'][$this->hashCode()] = true;
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(WorkMaterialTableMap::COL_IS_AVAILABLE)) {
            $criteria->add(WorkMaterialTableMap::COL_IS_AVAILABLE, $this->is_available);
        }
        if ($this->isColumnModified(WorkMaterialTableMap::COL_VERSION)) {
    ...
    {
        $criteria = ChildWorkMaterialQuery::create();
        $criteria->add(WorkMaterialTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\WorkMaterial (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\WorkMaterial Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getWork(?ConnectionInterface $con = null)
    {
        if ($this->aWork === null && ($this->work_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aWork->addWorkMaterials($this);
             */
        }
    ...
    {
        /** @var ChildWorkMaterialVersion[] $workMaterialVersionsToDelete */

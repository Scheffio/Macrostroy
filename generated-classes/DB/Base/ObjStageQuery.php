 ...
 *
 * @method     ChildObjStageQuery leftJoinUsers($relationAlias = null) Adds a LEFT JOIN clause to the query using the Users relation
 * @method     ChildObjStageQuery rightJoinUsers($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Users relation
 * @method     ChildObjStageQuery innerJoinUsers($relationAlias = null) Adds a INNER JOIN clause to the query using the Users relation
 *
 * @method     ChildObjStageQuery joinWithUsers($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Users relation
 *
 * @method     ChildObjStageQuery leftJoinWithUsers() Adds a LEFT JOIN clause and with to the query using the Users relation
 * @method     ChildObjStageQuery rightJoinWithUsers() Adds a RIGHT JOIN clause and with to the query using the Users relation
 * @method     ChildObjStageQuery innerJoinWithUsers() Adds a INNER JOIN clause and with to the query using the Users relation
 *
 ...
 *
 * @method     \DB\UsersQuery|\DB\ObjHouseQuery|\DB\ObjStageWorkQuery|\DB\ObjStageVersionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildObjStage|null findOneByVersionCreatedBy(int $version_created_by) Return the first ChildObjStage filtered by the version_created_by column
 ...
 * @method     ChildObjStage requireOneByVersionCreatedBy(int $version_created_by) Return the first ChildObjStage filtered by the version_created_by column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildObjStage[]|Collection findByVersionCreatedBy(int $version_created_by) Return ChildObjStage objects filtered by the version_created_by column
 * @psalm-method Collection&\Traversable<ChildObjStage> findByVersionCreatedBy(int $version_created_by) Return ChildObjStage objects filtered by the version_created_by column
...
protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';
    ...
    {
        $sql = 'SELECT id, name, status, is_public, is_available, house_id, version_created_by, version, version_created_at, version_comment FROM obj_stage WHERE id = :p0';
        try {
    ...
    public function filterByVersionCreatedBy($versionCreatedBy = null, ?string $comparison = null)
    {
        if (is_array($versionCreatedBy)) {
            ...
            if (isset($versionCreatedBy['min'])) {
                $this->addUsingAlias(ObjStageTableMap::COL_VERSION_CREATED_BY, $versionCreatedBy['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($versionCreatedBy['max'])) {
                $this->addUsingAlias(ObjStageTableMap::COL_VERSION_CREATED_BY, $versionCreatedBy['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByUsers($users, ?string $comparison = null)
    {
        if ($users instanceof \DB\Users) {
            return $this
                ->addUsingAlias(ObjStageTableMap::COL_VERSION_CREATED_BY, $users->getId(), $comparison);
            ...
            $this
                ->addUsingAlias(ObjStageTableMap::COL_VERSION_CREATED_BY, $users->toKeyValue('PrimaryKey', 'Id'), $comparison);
